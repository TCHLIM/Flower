 ...
 * @author user
 */
public class CatalogBirthday {

    public CatalogBirthday() {
    ...
    public static void main(String[] args, String month, String year, ListInterface<MadePayment> MPList) {
        ...
        try {
            PdfWriter.getInstance(d, new FileOutputStream("Catalog Order Bouquet Sales Report of " + printMonth + " " + year + ".pdf"));
            ...
            String text = "Catalog Order Bouquet Sales Report of " + printMonth + " " + year;
            ...
            for (int i = 0; i < MPList.size(); i++) {
                if (MPList.getEntry(i).getMPtype().equalsIgnoreCase("Birthday")) {
